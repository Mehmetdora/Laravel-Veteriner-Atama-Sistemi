    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><b>Antrepolar - Stok Takip</b></h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Kayıtlı Tüm Antrepolar</h3>
                            </div>
                                ...
                                <table id="example1" class="table table-bordered table-hover">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th>
                                                Antrepodaki Sağlık Sertifikası Sayısı
                                            </th>
                                            <th>
                                                İşlemler
                                            </th>
                                    ...
                                    <tbody>
                                        @if (isset($antrepos))
                                            @foreach ($antrepos as $antrepo)
                                                <tr class="text-center">
                                                    <td>
                                                        {{ $antrepo['antrepo']->name }}
                                                    </td>
                                                    <td>
                                                        {{ $antrepo['sertifika_count'] }}
                                                    </td>


                                                    <td class="project-actions ">
                                                        <a class="btn btn-primary btn-sm" href="{{route('admin.antrepo_stok_takip.detail',$antrepo['antrepo']->id)}}">
        ...
        $(function() {
            $("#example1").DataTable({
                ...
                buttons: [{
                        ...
                        text: 'PDF',
                        exportOptions: {
                            columns: [0, 1] // Tüm kolonları export eder
                        },
                    ...
                    },
                    {
                        ...
                        text: 'Excel',
                        exportOptions: {
                            columns: [0, 1] // Tüm kolonları dahil et
                        }
                    }
                ]
            });
