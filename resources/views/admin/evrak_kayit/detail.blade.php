        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <h1 class="m-0"><b>Evrak Detay</b></h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $evrak->updated_at->format('d-m-Y') }} |
                                                {{ $evrak->updated_at->timezone('Europe/Istanbul')->format('H:i') ?? 'Saat Yok' }}
                                            </td>
                                        </tr>
                                        ...
                                        @if ($type != 'EvrakAntrepoSertifika' && $type != 'EvrakCanliHayvanGemi')
                                            <tr>
                                                @if ($type == 'EvrakAntrepoVaris' || $type == 'EvrakAntrepoVarisDis' || $type == 'EvrakAntrepoCikis')
                                                    <th>VGB Numarası:</th>
                                                @else
