    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><b>Veteriner İzin Takvimi</b></h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.izin.veteriner.create') }}"><button
...
@section('admin.customJS')
    ...
    <script>
        ...
        function delete_izin(user_id, izin_id, start_date, end_date) {
            $.ajax({
                url: "{{ route('admin.izin.veteriner.delete') }}", // Laravel rotası
                method: "POST",
