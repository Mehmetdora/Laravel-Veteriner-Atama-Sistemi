...
@section('admin.content')
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2 align-items-center">
                    ...
                    <div class="col-sm-8 d-flex align-items-center">
                        <a class="btn btn-primary mr-2" href="{{ route('admin.nobet.veteriner.index') }}">Geri dön</a>
        ...
        <section class="content">
            ...
            <form action="{{ route('admin.nobet.multiple.veteriner.created') }}" method="POST">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('admin.nobet.multiple.veteriner.apply') }}" class="btn btn-info">
                        Evet, Uygula
                    </a>
                </div>
