        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <h1 class="m-0"><b>Yeni Veteriner Kaydı Yapma</b></h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <form method="post" action="{{ route('admin.veteriners.created') }}">
                                    ...
                                    <div class="form-group">
                                        <label name="password" class="control-label">Kullanıcının Şifresi: "Veteriner123" olarak atanmıştır. Lütfen kayıt yapıldıktan sonra yeni bir şifre belirleyiniz.</label>
                                        <input type="hidden" value="Veteriner123" name="password">
                                    </div>
