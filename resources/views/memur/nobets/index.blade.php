    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1><b>Veteriner Nöbet Takvimi</b></h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="mr-3">
                                <a href="{{ route('memur.nobet.multiple.veteriner.create') }}">
                            ...
                            <li class="breadcrumb-item">
                                <a href="#">
                                    <button class="btn btn-primary" onclick="exportCalendarToPDF()">Takvimi PDF
                                        Olarak İndir</button>
                                </a>
                            </li>
                        </ol>
                        ...
                        <div class="sticky-top mb-3">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tüm Veterinerler(Sürükle Bırak)</h4>
                                </div>
                                <div class="card-body">
                                    <!-- the events -->
...
@section('memur.customJS')
    ...
    <script>
        ...
        function create_nobet(vet_id, date) {
            $.ajax({
                url: "{{ route('memur.nobet.veteriner.created') }}", // Laravel rotası
                method: "POST",
        ...
        function edit_nobet(vet_id, old_date, new_date) {
            $.ajax({
                url: "{{ route('memur.nobet.veteriner.edited') }}", // Laravel rotası
                method: "POST",
                contentType: "application/json",
                data: JSON.stringify({
                    _token: "{{ csrf_token() }}",
        ...
        function delete_nobet(vet_id, date, sonuc) {
            $.ajax({
                url: "{{ route('memur.nobet.veteriner.deleted') }}", // Laravel rotası
                method: "POST",
                contentType: "application/json",
                data: JSON.stringify({
                    _token: "{{ csrf_token() }}",
